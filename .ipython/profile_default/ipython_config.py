...
#c.InteractiveShell.banner1 = "Python 3.5.4 |Anaconda custom (64-bit)| (default, Nov 20 2017, 18:44:38) \nType 'copyright', 'credits' or 'license' for more information\nIPython 6.2.1 -- An enhanced Interactive Python. Type '?' for help.\n"
...
#         highlighting:
#  borland, murphy, bw, friendly, rrt, vs, abap, tango, igor, lovelace, algol_nu, algol, manni, emacs, native, paraiso-light, colorful, fruity, default, rainbow_dash, trac, paraiso-dark, monokai, perldoc, arduino, autumn, vim, xcode, pastie
